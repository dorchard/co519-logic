...
(the \emph{conclusion}) from several other formulae that are assumed or known to be true
...
formulae. This is a compact representation of a formula $Q$ along with
...
formulae, constructing from proofs of its subformulas. Section 1.2.5
...
the \emph{context} of assumed formulae. The right hand side is
